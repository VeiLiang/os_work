...
// 20180609 增加视频项配额异常代码		
#define SYSTEM_EVENT_VIDEOITEM_PHOTO_FULL				86		// 照片的总容量超出系统预定义配额，需要手动删除
		
#define SYSTEM_EVENT_VIDEOITEM_PROTECT_VIDEO_FULL	87		// 紧急录像(手动和G-Sensor触发)的总容量超出系统预定义配额，需要手动删除
...
//acc连接事件
#define SYSTEM_EVENT_ACC_CONNECT                    146
//acc断开连接事件
#define SYSTEM_EVENT_ACC_LOST_CONNECT               147
...
#define AP_VIDEO_PRE_NEXT				0x10		// 上下视频选择


#define	XM_USER			0x80	// 用户自定义消息(0x80 ~ 0xFF)


#define XM_UPDATE_SLIDER	0x90//更新进度条
