...
#define _NUM_INT_VECTORS			32	// 32¸öÖÐ¶ÏÔ´

typedef void (*irq_handler_t) (void);
extern irq_handler_t itc_handler[_NUM_INT_VECTORS];
extern void _OS_ISR_Undefined(void);
...
extern void irq_disable(unsigned char irq);
extern void irq_enable(unsigned char irq);

#define	irq_mask		irq_disable
#define	irq_unmask	irq_enable


extern int request_irq(unsigned char irq, unsigned char priority, pfnIRQ handler);
