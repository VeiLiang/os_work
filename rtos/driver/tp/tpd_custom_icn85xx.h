...
#define TPD_POWER_SOURCE_CUSTOM     MT6323_POWER_LDO_VIO28 //MT6323_POWER_LDO_VGP1   //define your power source for tp if needed
#define TPD_POWER_SOURCE_VOL        VOL_3300

#define TPD_OK   0
#define SUPPORT_PROC_FS                  0//0
...
//#define TPD_SLIDE_WAKEUP

#define TPD_ICN85XX_I2C_DMA_SUPPORT    0



#define TPD_ICN85XX_I2C_ADDR			0x90
#define TPD_ICN85XX_PROG_I2C_ADDR		(0x60 >> 1)
#define TPD_ICN87XX_PROG_I2C_ADDR		(0x60 >> 1)
...
#define TPD_KEYS_DIM	{{100, 1000, 100, 50},{250, 1000, 100, 50},{400, 1000, 100, 50}}
