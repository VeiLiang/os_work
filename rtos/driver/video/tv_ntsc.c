...
// NTSC 制 
static void tv_ntsc_osd_init(void)
{
#define      lcd_enable             1
#define      screen_width           720//720
...
#define      lcd_ac_ivs             0
#define      rgb2yuv_en             0
#define		 Rgb2yuv_mode_sel			1		// RGB到YUV转换时，Y的数据选择，一般情况下配1。
														//		1：+16（Y最小值为16）；
														//		0：+0。
...
#define      DEN_h_rise             138         // pal 144   ntsc 138 // data enable ?ú????é?éyμ?????
#define      DEN_h_fall             (138+720*1) // pal 144   ntsc 138  
#define      DEN0_v_rise            18          // pal 23    ntsc 18  //even field data enable é?éy????
#define      DEN0_v_fall            258         // pal 311   ntsc 263
#define      DEN1_v_rise            280         // pal 336   ntsc 285
#define      DEN1_v_fall            520         // pal 624   ntsc 524
#define      CPL                    (858)       // pal 864   ntsc 858    // clock cycles per line  max 4096     ;  from register   timing2 16
#define      LPS                    (525)       // pal 625   ntsc 525    Lines per screen value  ;  from register   timing1 0
                                      
#define      HSW_rise                  ( 24 - 0    )
#define      HSW_fall                  ( 24+126 - 0 )
                                       
#define      VSW0_v_rise               ( 4       )   //pal 1     ntsc 4    // Vertical sync width value    ;  from register   timing1 10
#define      VSW0_v_fall               ( 6       )   //pal 3     ntsc 6    // Vertical sync width value     ;  from register   timing1 10
                                      
#define      VSW0_h_rise                1 
#define      VSW0_h_fall                (1)
                                      
#define      VSW1_v_rise                266          //pal 313   ntsc 266      // Vertical sync width value ;  from register   timing1 10
#define      VSW1_v_fall                269          //pal 316   ntsc 269     // Vertical sync width value  ;  from register   timing1 10
                                           
#define      VSW1_h_rise                858          //pal 864   ntsc 858
#define      VSW1_h_fall                858          //pal 864   ntsc 858

#define      sav_pos                   288
#define      f1_vblk_start             624
#define      f1_vblk_end               23
#define      f2_vblk_start             265           //pal 315   ntsc 265
...
static void tvencoder_ntsc_init(void)
{
//TV encoder setting
...
#define      bypass_yclamp                  0		// 亮度黑值选择  0：最小值为0；  1：最小值为16
#define      yc_delay                       4
...
#define      row79                          0
#define      row80                          0
	 LCD_TV_PARAM0_reg = chroma_freq_ntsc ;//此处定义 N制 P制
...
static void tv_ntsc_screen_init (void)
{
	unsigned int val;
