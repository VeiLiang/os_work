 ...
 *----------------------------------------------------------------------------*/
        ...
        PUBLIC  CP15_SETL1L2EX
		  PUBLIC  CP15_ReadAuxiliaryControl
		  PUBLIC  CP15_WriteAuxiliaryControl
		  ARM
...
CP15_WriteControl:
        ...
        bx      lr
 			...
 			ARM
        SECTION .CP15_ReadAuxiliaryControl:CODE:NOROOT(2)
        PUBLIC   CP15_ReadAuxiliaryControl
CP15_ReadAuxiliaryControl:
        mov     r0, #0
        ...
        bx      lr
 			...
 			ARM
        SECTION .CP15_WriteAuxiliaryControl:CODE:NOROOT(2)
        PUBLIC   CP15_WriteAuxiliaryControl
CP15_WriteAuxiliaryControl:
...
//       dcache_line_size r2, r3
        ...
        bx      lr
 			...
 			ARM
        SECTION .CP15_ReadVCR:CODE:NOROOT(2)
        PUBLIC   CP15_ReadVCR
CP15_ReadVCR:
        mov     r0, #0
        ...
        bx      lr
 			...
 			ARM
        SECTION .CP15_WriteVCR:CODE:NOROOT(2)
        PUBLIC   CP15_WriteVCR
CP15_WriteVCR:
        ...
        bx      lr
 			...
 			ARM
        SECTION .CP15_ReadSCR:CODE:NOROOT(2)
        PUBLIC   CP15_ReadSCR
CP15_ReadSCR:
        mov     r0, #0
        ...
        bx      lr
 			...
 			ARM
        SECTION .CP15_WriteSCR:CODE:NOROOT(2)
        PUBLIC   CP15_WriteSCR
CP15_WriteSCR:
