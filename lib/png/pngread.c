...
#ifdef PNG_TYPE_PALETTE_SUPPORTED
...
#ifdef PNG_FLAG_COLORMAP_SUPPORTED
...
png_image_read_colormap(png_voidp argument)
{
   ...
   switch (png_ptr->color_type)
   {
...
#endif
         break;
#endif	// #ifdef PNG_TYPE_GRAY_SUPPORTED

#ifdef PNG_TYPE_GRAY_ALPHA_SUPPORTED
      case PNG_COLOR_TYPE_GRAY_ALPHA:
         ...
         break;
#endif	// #ifdef PNG_TYPE_GRAY_ALPHA_SUPPORTED
...
#ifndef PNG_FLAG_COLORMAP_SUPPORTED
		if(image->format & PNG_FORMAT_FLAG_COLORMAP)
		{
			return png_image_error(image,
               "png_image_finish_read[color-map]: color-map unsupport");
		}
#endif
