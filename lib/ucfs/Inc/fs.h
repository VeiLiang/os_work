...
*/
#define FS_CMD_FLASH_WRITE_BACK	1002
...
U32         FS_GetDirPos  (FS_DIR     * pDir);
void        FS_SetDirPos  (FS_DIR     * pDir, U32 Pos);
...
struct FS_DEVICE_TYPE {      // Note: This definition is really intern and should be in "FS_Int.h". In order to avoid problems with old compilers, keep it here.
  ...
  int               (*pfWriteMultBuffer)       (U8 Unit, U32 SectorNo, U32 NumSectors, U32 NumBuffers, const U8 **pSectorBuffer, U32 *pSectorCount);
  int               (*pfReadMultBuffer)        (U8 Unit, U32 SectorNo, U32 NumSectors, U32 NumBuffers,       U8 **pSectorBuffer, U32 *pSectorCount);
};
...
extern const FS_DEVICE_TYPE    FS_MMC_CardMode_Driver;  /* MMC_DRIVER CardMode function table */
extern const FS_DEVICE_TYPE    FS_MMC_SPI_Driver;       /* MMC_DRIVER SPI function table */
...
extern const FS_DEVICE_TYPE    FS_SPIFLASH_Driver;      /* Serial Flash driver function table */
extern const FS_DEVICE_TYPE    FS_SDMMC_Driver;         /* SD&MMC0 CardMode function table */
extern const FS_DEVICE_TYPE    FS_SDMMC1_Driver;         /* SD&MMC1 CardMode function table */
extern const FS_DEVICE_TYPE    FS_SDMMC2_Driver;         /* SD&MMC2 CardMode function table */

extern const FS_DEVICE_TYPE    FS_MUSB_driver;       /*MUSBSTACK USB Disk driver function table */
//extern const FS_DEVICE_TYPE    FS_USBDISK_Driver;       /* USB Disk driver function table */
extern const FS_DEVICE_TYPE    FS_NF_Driver;      	 /* Nand driver function table */
