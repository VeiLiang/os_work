...
#ifndef   FS_SUPPORT_FAT_CHAIN
  #define FS_SUPPORT_FAT_CHAIN          0
#endif

#ifndef  FS_FAT_TABLE_CACHE
 #define FS_FAT_TABLE_CACHE			0
#endif

#ifndef FS_FAT_USE_CLUSTER_CACHE
#define FS_FAT_USE_CLUSTER_CACHE			1
//#define FS_FAT_USE_CLUSTER_CACHE			0	
#endif


#ifndef   FS_SUPPORT_LFN_INFO
  #define FS_SUPPORT_LFN_INFO           1
#endif

#ifndef   FS_MAX_FAT_CHAIN
  #define FS_MAX_FAT_CHAIN           1024
#endif

#ifndef   FS_LFN_INFO_OFFSET
  #define FS_LFN_INFO_OFFSET           16
#endif
  ...
  #define FS_MAX_LEN_FULL_FILE_NAME		FS_MAX_PATH
#endif

#ifndef   FS_DRIVER_ALIGMENT
  #define FS_DRIVER_ALIGMENT            4
#endif
  ...
  #define FS_SUPPORT_CHECK_MEMORY      0
#endif
...
#ifndef   FS_PREFETCH_FAT
  #define FS_PREFETCH_FAT	1
	//#define FS_PREFETCH_FAT	0
#endif
...
*/
  ...
  #define FS_OS_LOCK_PER_DRIVER 1        /* 0 = means a single lock for all files, 1 means one lock per file */
#endif
...
//  #define FS_NUM_VOLUMES 1
  #define FS_NUM_VOLUMES 2
#endif


#ifndef   FS_NUM_FILE_HANDLES
  //#define FS_NUM_FILE_HANDLES    128 + (FS_SUPPORT_EFS * 2)
  #define FS_NUM_FILE_HANDLES    16 + (FS_SUPPORT_EFS * 2)
#endif

#ifndef   FS_NUM_FILE_OBJECTS
  #define FS_NUM_FILE_OBJECTS    FS_NUM_FILE_HANDLES
#endif

#ifndef   FS_NUM_DIR_HANDLES
  #define FS_NUM_DIR_HANDLES     32
#endif
