...
#define	_VIDEOITEM_SUPPORT_			// 视频项支持
...
#define	_XMSYS_FS_CACHE_SIZE_				0x600000		// 4MB文件系统Cache		
...
//#define	_XMSYS_RTC_								_XMSYS_RTC_HARDWARE_		// 系统使用软件RTC
		
#define	T18XX_IISADC_1CH						1
#define	T18XX_IISADC_4CH						2
		
//#define	T18XX_IISADC							T18XX_IISADC_1CH
#define	T18XX_IISADC							T18XX_IISADC_4CH		
		
#define	_BB_BOARD_SDRAM16_					1		// 16位SDRAM接口开发板
#define	_BB_BOARD_SDRAM32_					2		// 32位SDRAM接口开发板
		
//#define	_BB_BOARD_						_BB_BOARD_SDRAM32_	// 使用32位开发板
#define	_BB_BOARD_						_BB_BOARD_SDRAM16_	// 使用32位开发板		
		
#define	_USB_DEV_0_						1
#define	_USB_DEV_1_						2
		
		
#define	_SENSOR_CHIP_MIK2465_			1		// MIK2465 4通道D1
#define	_SENSOR_CHIP_VC0715H_			2		// 中星微VC0715H 4通道D1 
		
#define	_SENSOR_CHIP_						_SENSOR_CHIP_MIK2465_
//#define	_SENSOR_CHIP_						_SENSOR_CHIP_VC0715H_		
		
#if _BB_BOARD_ == _BB_BOARD_SDRAM32_
#define	_USB_DEV_		_USB_DEV_1_			// 32bit SDRAMDVR项目使用USB 设备1
#else
...
#define	_XM_PROJ_1_SENSOR_720P_			1
#define	_XM_PROJ_1_SENSOR_D1_			2
#define	_XM_PROJ_4_SENSOR_D1_			3
#define	_XM_PROJ_2_SENSOR_720P_D1		4
		
#define	_XM_PROJ_DVR_4_SENSOR_D1_		5		// 4路D1 DVR项目(16bir SDRAM)
#define	_XM_PROJ_DVR_1_SENSOR_720P_		6		// 1路720P DVR项目(16bit SDRAM)
...
//#define	_XM_PROJ_	_XM_PROJ_1_SENSOR_D1_
//#define	_XM_PROJ_	_XM_PROJ_4_SENSOR_D1_	
//#define	_XM_PROJ_	_XM_PROJ_1_SENSOR_720P_	
//#define	_XM_PROJ_	_XM_PROJ_2_SENSOR_720P_D1	
//#define	_XM_PROJ_	_XM_PROJ_DVR_4_SENSOR_D1_	
#define	_XM_PROJ_	_XM_PROJ_DVR_1_SENSOR_720P_	
...
#if _XM_PROJ_ == _XM_PROJ_1_SENSOR_D1_

// **************** 1个摄像头 D1 *******************
#define	XMSYS_SENSOR_COUNT							1
		
// 通道0摄像头帧字节大小定义
#if D1_SENSOR_TYPE == D1_SENSOR_TYPE_NTSC

#define	XMSYS_CH0_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH0_SENSOR_FRAME_HEIGHT				480

#elif D1_SENSOR_TYPE == D1_SENSOR_TYPE_PAL
		
#define	XMSYS_CH0_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH0_SENSOR_FRAME_HEIGHT				576
		
#endif
		
#elif _XM_PROJ_ == _XM_PROJ_4_SENSOR_D1_
		
// **************** 4个摄像头 D1 *******************
		
#define	XMSYS_SENSOR_COUNT							4

#if D1_SENSOR_TYPE == D1_SENSOR_TYPE_NTSC

#define	XMSYS_CH0_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH0_SENSOR_FRAME_HEIGHT				480
#define	XMSYS_CH1_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH1_SENSOR_FRAME_HEIGHT				480
#define	XMSYS_CH2_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH2_SENSOR_FRAME_HEIGHT				480
#define	XMSYS_CH3_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH3_SENSOR_FRAME_HEIGHT				480
...
#define	XMSYS_CH0_SENSOR_FRAME_HEIGHT				576
#define	XMSYS_CH1_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH1_SENSOR_FRAME_HEIGHT				576
#define	XMSYS_CH2_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH2_SENSOR_FRAME_HEIGHT				576
#define	XMSYS_CH3_SENSOR_FRAME_WIDTH				704
#define	XMSYS_CH3_SENSOR_FRAME_HEIGHT				576
		
#endif
		
	
#elif _XM_PROJ_ == _XM_PROJ_1_SENSOR_720P_
...
#elif _XM_PROJ_ == _XM_PROJ_2_SENSOR_720P_D1
...
// XMSYS_CH1_SENSOR_SOFTWARE_SIMULATE 标记是否软件模拟D1摄像头
// 1 软件模拟
// 0 物理摄像头
#define XMSYS_CH1_SENSOR_SOFTWARE_SIMULATE					1	
...
// 定义D1摄像头输出图像缓冲区的宽度/高度 (适用于NTSC/PAL制式)
#define XMSYS_D1_SENSOR_FRAME_WIDTH					640
#define XMSYS_D1_SENSOR_FRAME_HEIGHT				576

#define XMSYS_NTSC_SENSOR_FRAME_WIDTH				640
#define XMSYS_NTSC_SENSOR_FRAME_HEIGHT				480

#define XMSYS_PAL_SENSOR_FRAME_WIDTH				640
#define XMSYS_PAL_SENSOR_FRAME_HEIGHT				576
		
#define	XMSYS_SENSOR_COUNT							4

#define	XMSYS_CH0_SENSOR_FRAME_WIDTH				XMSYS_D1_SENSOR_FRAME_WIDTH
#define	XMSYS_CH0_SENSOR_FRAME_HEIGHT				XMSYS_D1_SENSOR_FRAME_HEIGHT
#define	XMSYS_CH1_SENSOR_FRAME_WIDTH				XMSYS_D1_SENSOR_FRAME_WIDTH
#define	XMSYS_CH1_SENSOR_FRAME_HEIGHT				XMSYS_D1_SENSOR_FRAME_HEIGHT
#define	XMSYS_CH2_SENSOR_FRAME_WIDTH				XMSYS_D1_SENSOR_FRAME_WIDTH
#define	XMSYS_CH2_SENSOR_FRAME_HEIGHT				XMSYS_D1_SENSOR_FRAME_HEIGHT
#define	XMSYS_CH3_SENSOR_FRAME_WIDTH				XMSYS_D1_SENSOR_FRAME_WIDTH
#define	XMSYS_CH3_SENSOR_FRAME_HEIGHT				XMSYS_D1_SENSOR_FRAME_HEIGHT			

#elif _XM_PROJ_ == _XM_PROJ_DVR_1_SENSOR_720P_
...
// 通道2摄像头帧字节大小定义
#define	XMSYS_CH2_SENSOR_FRAME_SIZE				(XMSYS_CH2_SENSOR_FRAME_WIDTH*(XMSYS_CH2_SENSOR_FRAME_HEIGHT + 0)*3/2)
// 通道3摄像头帧字节大小定义
#define	XMSYS_CH3_SENSOR_FRAME_SIZE				(XMSYS_CH3_SENSOR_FRAME_WIDTH*(XMSYS_CH3_SENSOR_FRAME_HEIGHT + 0)*3/2)


// REMOTE_TOY_CAMERA模拟宏定义		
#define	_XMSYS_REMOTE_TOY_CAMERA_DEVICE_SW_		0		// 软件模拟方式
#define	_XMSYS_REMOTE_TOY_CAMERA_DEVICE_HW_		1		// 硬件设备方式

#if _XM_PROJ_ == _XM_PROJ_DVR_4_SENSOR_D1_		
// 仅在D1中采用
#define	_XMSYS_REMOTE_TOY_CAMERA_DEVICE_			_XMSYS_REMOTE_TOY_CAMERA_DEVICE_SW_
#else
#define	_XMSYS_REMOTE_TOY_CAMERA_DEVICE_			_XMSYS_REMOTE_TOY_CAMERA_DEVICE_HW_		
#endif
