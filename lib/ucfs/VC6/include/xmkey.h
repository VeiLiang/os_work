...
#define VK_AP_MENU        0x70    // VK_F1 菜单键(播放/暂停)
#define VK_AP_MODE        0x71     // VK_F2 模式切换键
#define VK_AP_SWITCH      0x72     // VK_F3 显示切换键 
#define VK_AP_POWER       0x01     // POWER 电源键(录像启动、录像结束)
...
#define VK_AP_FONT_BACK_SWITCH        VK_F11 //停止/开始录
