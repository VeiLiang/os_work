...
#define SATA_BASE					0x70080000			//	ahb_sata	32' h7008_0000, 64K
...
//#define  SCALE_BASE     		 0x70130000
#define MEMCTL_BASE				0x70140000			//	ahb_memctl	32'h7014_0000,64K
#define ITU656_BASE				0x70180000			//	ahb_656		32'h7018_0000,64K
#define LCD_BASE					0x70190000			//	ahb_lcd		32'h7019_0000,64K
#define IPU_BASE					0x701A0000			//	ahb_ipu		32'h701a_0000,64K
...
#define I2S_BASE					0x40801000			//	apb_i2s1		32'h4040_1000,4K
...
//#define MBX_BASE			0xE0F00000

//#define SSI_BASE				0xE4100000
//#define RPC_BASE			0xE4400000


#define ARK_REGFILE_BASE		MFC_BASE
...
//#define rSYS_BACKLIGHT_CTL_D							*((volatile unsigned int *)(SYS_BASE+0x7c))
//#define rSYS_BACKLIGHT_CTL_E							*((volatile unsigned int *)(SYS_BASE+0x80))
//#define rSYS_BACKLIGHT_CTL_F							*((volatile unsigned int *)(SYS_BASE+0x84))
//#define rSYS_BACKLIGHT_CTL_10							*((volatile unsigned int *)(SYS_BASE+0x88))
//#define rSYS_BACKLIGHT_CTL_11							*((volatile unsigned int *)(SYS_BASE+0x8c))
//#define rSYS_BACKLIGHT_CTL_12							*((volatile unsigned int *)(SYS_BASE+0x90))
//#define rSYS_KEY_CLK_CFG								*((volatile unsigned int *)(SYS_BASE+0x94))
//#define rSYS_GPU_CTL									*((volatile unsigned int *)(SYS_BASE+0x98))
//#define rSYS_GPIO_CLK_REF								*((volatile unsigned int *)(SYS_BASE+0x9C))
//#define rSYS_CLK_DLY									*((volatile unsigned int *)(SYS_BASE+0xA0))


//#define rSYS_AHB_SOFT_RST_N_A							*((volatile unsigned int *)(SYS_BASE+0xc0))
//#define rSYS_AHB_SOFT_RST_N_B							*((volatile unsigned int *)(SYS_BASE+0xc4))
...
#define rSYS_BKLT_CTLG								*((volatile unsigned int *)(SYS_BASE+0x190))
#define rSYS_BKLT_CTLH								*((volatile unsigned int *)(SYS_BASE+0x194))
...
//#define rISP_SCALE_WB_YADDR                   (*(volatile unsigned int  *) (ISP_SCALE_BASE +  0x4c ))
//#define rISP_SCALE_WB_UVADDR                  (*(volatile unsigned int  *) (ISP_SCALE_BASE +  0x50 ))
...
//remap
#define rREMAP                       				(*(volatile unsigned int *)(RPC_BASE + 0x20))
...
/* Hight Speed UART4 */
#define UART4_URXD             *((volatile unsigned int *)(UART4_BASE + 0x0000))
#define UART4_UTXD             *((volatile unsigned int *)(UART4_BASE + 0x0040))
#define UART4_UCR1             *((volatile unsigned int *)(UART4_BASE + 0x0080))
#define UART4_UCR2             *((volatile unsigned int *)(UART4_BASE + 0x0084))
#define UART4_UCR3             *((volatile unsigned int *)(UART4_BASE + 0x0088))
#define UART4_UCR4             *((volatile unsigned int *)(UART4_BASE + 0x008C))
#define UART4_UFCR             *((volatile unsigned int *)(UART4_BASE + 0x0090))
#define UART4_USR1             *((volatile unsigned int *)(UART4_BASE + 0x0094))
#define UART4_USR2             *((volatile unsigned int *)(UART4_BASE + 0x0098))
#define UART4_UESC             *((volatile unsigned int *)(UART4_BASE + 0x009C))
#define UART4_UTIM             *((volatile unsigned int *)(UART4_BASE + 0x00A0))
#define UART4_UBIR             *((volatile unsigned int *)(UART4_BASE + 0x00A4))
#define UART4_UBMR             *((volatile unsigned int *)(UART4_BASE + 0x00A8))
#define UART4_UBRC             *((volatile unsigned int *)(UART4_BASE + 0x00AC))
#define UART4_ONEMS            *((volatile unsigned int *)(UART4_BASE + 0x00B0))
#define UART4_UTS              *((volatile unsigned int *)(UART4_BASE + 0x00B4))
#define UART4_TXFIFO 	 	(UART4_BASE + 0x0040)
#define UART4_RXFIFO        	(UART4_BASE + 0x0000)

/* Hight Speed UART5 */
#define UART5_URXD             *((volatile unsigned int *)(UART5_BASE + 0x0000))
#define UART5_UTXD             *((volatile unsigned int *)(UART5_BASE + 0x0040))
#define UART5_UCR1             *((volatile unsigned int *)(UART5_BASE + 0x0080))
#define UART5_UCR2             *((volatile unsigned int *)(UART5_BASE + 0x0084))
#define UART5_UCR3             *((volatile unsigned int *)(UART5_BASE + 0x0088))
#define UART5_UCR4             *((volatile unsigned int *)(UART5_BASE + 0x008C))
#define UART5_UFCR             *((volatile unsigned int *)(UART5_BASE + 0x0090))
#define UART5_USR1             *((volatile unsigned int *)(UART5_BASE + 0x0094))
#define UART5_USR2             *((volatile unsigned int *)(UART5_BASE + 0x0098))
#define UART5_UESC             *((volatile unsigned int *)(UART5_BASE + 0x009C))
#define UART5_UTIM             *((volatile unsigned int *)(UART5_BASE + 0x00A0))
#define UART5_UBIR             *((volatile unsigned int *)(UART5_BASE + 0x00A4))
#define UART5_UBMR             *((volatile unsigned int *)(UART5_BASE + 0x00A8))
#define UART5_UBRC             *((volatile unsigned int *)(UART5_BASE + 0x00AC))
#define UART5_ONEMS            *((volatile unsigned int *)(UART5_BASE + 0x00B0))
#define UART5_UTS              *((volatile unsigned int *)(UART5_BASE + 0x00B4))
#define UART5_TXFIFO 	 	(UART5_BASE + 0x0040)
#define UART5_RXFIFO        	(UART5_BASE + 0x0000)
...
/*#define rSSI_CTRLR0          			(*(volatile unsigned int *)(SSI_BASE + 0x00))
#define rSSI_CTRLR1          			(*(volatile unsigned int *)(SSI_BASE + 0x04))
#define rSSI_SSIENR          			(*(volatile unsigned int *)(SSI_BASE + 0x08))
#define rSSI_MWCR           			(*(volatile unsigned int *)(SSI_BASE + 0x0C))
#define rSSI_SER            			(*(volatile unsigned int *)(SSI_BASE + 0x10))
#define rSSI_BAUDR           			(*(volatile unsigned int *)(SSI_BASE + 0x14))
#define rSSI_TXFTLR         			(*(volatile unsigned int *)(SSI_BASE + 0x18))
#define rSSI_RXFTLR        				(*(volatile unsigned int *)(SSI_BASE + 0x1C))
#define rSSI_TXFLR           			(*(volatile unsigned int *)(SSI_BASE + 0x20))
#define rSSI_RXFLR           			(*(volatile unsigned int *)(SSI_BASE + 0x24))
#define rSSI_SR           				(*(volatile unsigned int *)(SSI_BASE + 0x28))
#define rSSI_IMR            			(*(volatile unsigned int *)(SSI_BASE + 0x2C))
#define rSSI_ISR            			(*(volatile unsigned int *)(SSI_BASE + 0x30))
#define rSSI_RISR            			(*(volatile unsigned int *)(SSI_BASE + 0x34))
#define rSSI_TXOICR            			(*(volatile unsigned int *)(SSI_BASE + 0x38))
#define rSSI_RXOICR            			(*(volatile unsigned int *)(SSI_BASE + 0x3C))
#define rSSI_RXUICR            			(*(volatile unsigned int *)(SSI_BASE + 0x40))
#define rSSI_MSTICR            			(*(volatile unsigned int *)(SSI_BASE + 0x44))
#define rSSI_ICR            			(*(volatile unsigned int *)(SSI_BASE + 0x48))
#define rSSI_DMACR            			(*(volatile unsigned int *)(SSI_BASE + 0x4C))
#define rSSI_DMATDLR            		(*(volatile unsigned int *)(SSI_BASE + 0x50))
#define rSSI_DMARDLR            		(*(volatile unsigned int *)(SSI_BASE + 0x54))
#define rSSI_IDR            			(*(volatile unsigned int *)(SSI_BASE + 0x58))
#define rSSI_SSI_COMP_VERSION   		(*(volatile unsigned int *)(SSI_BASE + 0x5C))
#define rSSI_DR					 	    (*(volatile unsigned int *)(SSI_BASE + 0x60))
#define SSI_FIFO                					(SSI_BASE + 0x60)*/
