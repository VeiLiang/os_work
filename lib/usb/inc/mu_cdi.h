 ...
 * @param 2 IRP pointer
 */
typedef void (*MUSB_pfIrpComplete)(void*, struct _MUSB_Irp*);
...
typedef struct _MUSB_DeviceDriver
{
    ...
    uint8_t (*client_app_connect_ind)(void* pPrivateData);
    uint8_t (*client_app_discon_ind)(void* pPrivateData);	
} MUSB_DeviceDriver;
 ...
 *****************************************************************************/
extern uint8_t MUSB_User_App_Connect_Ind(void *pPrivateData);
 ...
 *              at the time of usb_client structure initialization)
 *****************************************************************************/
extern uint8_t MUSB_User_App_Discon_Ind(void *pPrivateData);
