...
//#define MUSB_HUB_LOGICAL_POWER_SWITCH_MODE_BM	0x03		//Former
#define MUSB_HUB_LOGICAL_POWER_SWITCH_MODE_BM	0x80		//Nicholas Xu
...
typedef enum {
    ...
    MUSB_HUB_MAX_DEBOUNCE_TIME				=  500,
    MUSB_HUB_INCREMENT_DEBOUNCE_TIME		=  100,
