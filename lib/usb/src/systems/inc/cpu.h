...
*                                         'cpu_cfg.h' to enable C-source-optimized function(s) otherwise
*
*           (2) The CLZ (count leading zeroes) assembly instruction is only available in ARM mode for the 
*               following ARM cores (version 5 architectures & above) :
*
*                       __ARM5__
*                       __ARM6__
*                       __ARM6M__       See Note #3a1
*                       __ARM6SM__      See Note #3a1
*                       __ARM7M__       See Note #3a1
*                       __ARM7EM__      See Note #3a1
*                       __ARM7R__       See Note #3a1
*
*           (3) (a) '__CORE__' is an IAR compiler #define that reflects the '--cpu' option, indicating the 
*                   architecture/processor in use :
*
*                       __ARM4M__
*                       __ARM4TM__
*                       __ARM5__
...
*                       __ARM7R__
*
*                   (1) For ARM-M & ARM-R profiles (ARM Cortex M3 & ARM Cortex R4, respectively), the 'cpu.h' 
*                       port file from the appropriate CPU port directory should be used instead :
*
*                       (A) \<CPU-Compiler Directory>\ARM-Cortex-M3\<compiler>\cpu.h
*                       (B) \<CPU-Compiler Directory>\ARM-Cortex-R4\<compiler>\cpu.h
*
*                           where
*                                   <CPU-Compiler Directory>    directory path for common   CPU-compiler software
*                                   <compiler>                  directory name for specific compiler
*
*               (b) '__CPU_MODE__' is an IAR compiler #define that reflects the selected CPU mode :
*
*                   (1) '1' for Thumb
*                   (2) '2' for ARM
*********************************************************************************************************
...
#ifdef   CPU_CFG_LEAD_ZEROS_ASM_PRESENT                         /* Configure CPU count leading  zeros bits ...          */
#undef   CPU_CFG_LEAD_ZEROS_ASM_PRESENT                         /* ... assembly-version (see Note #1a).                 */
#endif

#if ((defined(__CORE__    ))                            && \
    ((defined(__CPU_MODE__)) && (__CPU_MODE__ == 2   )) && \
   (((defined(__ARM5__    )) && (__CORE__ == __ARM5__)) || \
    ((defined(__ARM6__    )) && (__CORE__ == __ARM6__))))
#define  CPU_CFG_LEAD_ZEROS_ASM_PRESENT                         /* See Note #2.                                         */
#endif
